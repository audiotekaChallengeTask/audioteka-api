...
class RemoveProductFromBasketVoter extends Voter
{
    const PERMISSION = 'REMOVE_PRODUCT_FROM_BASKET';
    ...
    protected function voteOnAttribute(string $attribute, $subject, TokenInterface $token)
    {
        ...
        return true === $this->repository->basketHasProduct($subject, $basket);
    }
}
