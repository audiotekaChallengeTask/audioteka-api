...
class HasBasketVoterTest extends AbstractVoterTest
{
    public function setUp(): void
    {
        parent::setUp();
        $this->instance = new HasBasketVoter($this->basketProvider);
    }
    ...
    public function test_when_there_is_basket()
    {
        ...
        $this->assertSame(Voter::ACCESS_GRANTED, $this->instance->vote($this->token, null, [HasBasketVoter::PERMISSION]));
    }
    ...
    public function test_when_there_is_no_basket()
    {
        ...
        $this->assertSame(Voter::ACCESS_DENIED, $this->instance->vote($this->token, null, [HasBasketVoter::PERMISSION]));
    }
}
